            ...
            <section className="flex flex-col text-center items-center justify-center min-h-screen bg-gray-300 gap-5 py-6">
                ...
                {categorie === "et4x" && (
                    <div className="flex flex-col gap-5">
                        ...
                        <p>
                            Les tablettes grand public peuvent apparaître comme des options rentables pour votre entreprise, car leur prix semble juste. Mais sans les bonnes fonctionnalités, les<br/>
                            économies peuvent rapidement se transformer en coûts cachés : vous devrez peut-être acheter un boîtier pour augmenter la durabilité de la tablette ou un scanner pour les<br/>
                ...
                {categorie === "et4x-hc" && (
                    <div className="flex flex-col gap-5">
                        ...
                        <p>
                            Les tablettes grand public peuvent sembler rentables du fait de leur prix. Mais leur manque de fonctionnalités pour le secteur de la santé crée des problèmes de sécurité<br/>
                            et des coûts, allant de l’impossibilité de désinfecter pour empêcher la propagation des germes à la nécessité d’acheter des scanners pour la capture de codes-barres et au<br/>
                ...
                {categorie === "et6x" && (
                    <div className="flex flex-col gap-5">
                        ...
                        <p>
                            Boostez votre productivité et l’efficacité de votre entreprise avec des tablettes professionnelles qui en font plus : plus de fonctionnalité, de puissance, de sécurité et<br/>
                            de robustesse, mais aussi plus de polyvalence. Ces tablettes Android et Windows dopées par l’IA sont conçues pour un travail intensif. Les tablettes ET6x présentent une<br/>
                            esthétique similaire à celles destinées au grand public, mais solides comme un char d’assaut et prêtes à affronter les environnements les plus hostiles ! Le moteur d’IA<br/>
                ...
                {categorie === "et8x" && (
                    <div className="flex flex-col gap-5">
                        ...
                        <p>
                            Équipes de secours, techniciens de service sur le terrain et ressources en usine sur la ligne de production, vous avez tous une chose essentielle en commun : vous êtes<br/>
                            indispensables au bon fonctionnement de la société. Nombreux sont ceux qui comptent sur vous. Il vous faut un terminal mobile fiable et ultra-performant, où que vous soyez,<br/>
