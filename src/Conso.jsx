                            ...
                            <div>
                                ...
                                <div className="grid md:grid-cols-3 grid-cols-1 gap-7">
                                    <div className="flex flex-col text-start w-70 bg-white rounded-2xl p-4 gap-4">
                                        ...
                                        <h1 className="text-2xl font-bold">8100T CryoCool</h1>
                                        ...
                                        <button onClick={() => {navigate("/consommables/SAMPLE35938"),window.scrollTo(0,0)}} className="bg-black mt-auto text-white hover:bg-orange-500 w-45 self-center h-11 rounded-2xl text-[16px] font-bold">Voir le produit</button>
                                    </div>
                                    <div className="flex flex-col text-start w-70 bg-white rounded-2xl p-4 gap-4">
                                        <img src={t2000} alt="" className="flex w-55 mx-auto" />
                                        <h1 className="text-2xl font-bold">Z-Select 2000T Label</h1>
                                        ...
                                        <button onClick={() => {navigate("/consommables/76528"),window.scrollTo(0,0)}} className="bg-black mt-auto text-white hover:bg-orange-500 w-45 self-center h-11 rounded-2xl text-[16px] font-bold">Voir le produit</button>
                                    </div>
                                    <div className="flex flex-col text-start w-70 bg-white rounded-2xl p-4 gap-4">
                                        <img src={etiq03} alt="" className="flex w-55 mx-auto" />
                                        <h1 className="text-2xl font-bold">PolyPro 3000T Clear Label</h1>
                                        ...
                                        <button onClick={() => {navigate("/consommables/3004428"),window.scrollTo(0,0)}} className="bg-black mt-auto text-white hover:bg-orange-500 w-45 self-center h-11 rounded-2xl text-[16px] font-bold">Voir le produit</button>
                                    </div>
                                    <div className="flex flex-col text-start w-70 bg-white rounded-2xl p-4 gap-4">
                                        <img src={t2000} alt="" className="flex w-55 mx-auto" />
                                        <h1 className="text-2xl font-bold">Z-Select 2000T Label</h1>
                                        ...
                                        <button onClick={() => {navigate("/consommables/76054"),window.scrollTo(0,0)}} className="bg-black mt-auto text-white hover:bg-orange-500 w-45 self-center h-11 rounded-2xl text-[16px] font-bold">Voir le produit</button>
                                    </div>
                                    <div className="flex flex-col text-start w-70 bg-white rounded-2xl p-4 gap-4">
                                        <img src={d2000} alt="" className="flex w-55 mx-auto" />
                                        <h1 className="text-2xl font-bold">Z-Select 2000D Label</h1>
                                        ...
                                        <button onClick={() => {navigate("/consommables/800262-125"),window.scrollTo(0,0)}} className="bg-black mt-auto text-white hover:bg-orange-500 w-45 self-center h-11 rounded-2xl text-[16px] font-bold">Voir le produit</button>
                                    </div>
                                    <div className="flex flex-col text-start w-70 bg-white rounded-2xl p-4 gap-4">
                                        <img src={etiq06} alt="" className="flex w-55 mx-auto" />
                                        <h1 className="text-2xl font-bold">Z-Select 2000D Label</h1>
                                        <p>LAB-RL-DT-PAP-50,8X25,4MM</p>
                                        <button onClick={() => {navigate("/consommables/3014816-T"),window.scrollTo(0,0)}} className="bg-black mt-auto text-white hover:bg-orange-500 w-45 self-center h-11 rounded-2xl text-[16px] font-bold">Voir le produit</button>
                                    </div>
                                    <div className="flex flex-col text-start w-70 bg-white rounded-2xl p-4 gap-4">
                                        <img src={etiq07} alt="" className="flex w-55 mx-auto" />
                                        <h1 className="text-2xl font-bold">Z-Perform 1000T Label</h1>
                                        ...
                                        <button onClick={() => {navigate("/consommables/880003-025D"),window.scrollTo(0,0)}} className="bg-black mt-auto text-white hover:bg-orange-500 w-45 self-center h-11 rounded-2xl text-[16px] font-bold">Voir le produit</button>
                                    </div>
                                </div>
                            </div>
                        )}
                            ...
                            <div>
                                ...
                                <div className="grid md:grid-cols-3 grid-cols-1 gap-7">
                                    <div className="flex flex-col text-start w-70 bg-white rounded-2xl p-4 gap-4">
                                        ...
                                        <h1 className="text-2xl font-bold">Sample Wax Resin Ribbon</h1>
                                        <p>Échantillon de ruban en résine cirée, 110 mm x 50 m, 3200, haute performance, âme de 25 mm</p>
                                        <button onClick={() => {navigate("/consommables/03200BK11005"),window.scrollTo(0,0)}} className="bg-black mt-auto text-white hover:bg-orange-500 w-45 self-center h-11 rounded-2xl text-[16px] font-bold">Voir le produit</button>
                                    </div>
                                    <div className="flex flex-col text-start w-70 bg-white rounded-2xl p-4 gap-4">
                                        <img src={ribbon02} alt="" className="flex w-55 mx-auto" />
                                        <h1 className="text-2xl font-bold">Sample TT RIBBON GOLD</h1>
                                        <p>Échantillon de ruban zèbre doré 110 mm x 50 m</p>
                                        <button onClick={() => {navigate("/consommables/05319GD11005"),window.scrollTo(0,0)}} className="bg-black mt-auto text-white hover:bg-orange-500 w-45 self-center h-11 rounded-2xl text-[16px] font-bold">Voir le produit</button>
                                    </div>
                                    <div className="flex flex-col text-start w-70 bg-white rounded-2xl p-4 gap-4">
                                        <img src={ribbon03} alt="" className="flex w-55 mx-auto" />
                                        <h1 className="text-2xl font-bold">Sample TT RIBBON BLACK</h1>
                                        <p>Échantillon de ruban zebra TT noir 110 mm 50 m</p>
                                        <button onClick={() => {navigate("/consommables/05095BK11005"),window.scrollTo(0,0)}} className="bg-black mt-auto text-white hover:bg-orange-500 w-45 self-center h-11 rounded-2xl text-[16px] font-bold">Voir le produit</button>
                                    </div>
                                    <div className="flex flex-col text-start w-70 bg-white rounded-2xl p-4 gap-4">
                                        <img src={ribbon04} alt="" className="flex w-55 mx-auto" />
                                        <h1 className="text-2xl font-bold">1600 Wax</h1>
                                        <p>Ruban ciré, 110 mm x 450 m (4,33 po x 1476 pi), 1600 unités, standard, mandrin de 25 mm (1 po), 18 unités/boîte</p>
                                        <button onClick={() => {navigate("/consommables/01600BK11045"),window.scrollTo(0,0)}} className="bg-black mt-auto text-white hover:bg-orange-500 w-45 self-center h-11 rounded-2xl text-[16px] font-bold">Voir le produit</button>
                                    </div>
                                    <div className="flex flex-col text-start w-70 bg-white rounded-2xl p-4 gap-4">
                                        <img src={ribbon05} alt="" className="flex w-55 mx-auto" />
                                        <h1 className="text-2xl font-bold">2300 Wax</h1>
                                        <p>Ruban ciré, 64 mm x 74 m, 2300, standard, mandrin de 12 mm, 12/boîte</p>
                                        <button onClick={() => {navigate("/consommables/02300GS06407"),window.scrollTo(0,0)}} className="bg-black mt-auto text-white hover:bg-orange-500 w-45 self-center h-11 rounded-2xl text-[16px] font-bold">Voir le produit</button>
                                    </div>
                                    <div className="flex flex-col text-start w-70 bg-white rounded-2xl p-4 gap-4">
                                        <img src={ribbon06} alt="" className="flex w-55 mx-auto" />
                                        <h1 className="text-2xl font-bold">3200 Wax/Resin</h1>
                                        <p>Ruban cire/résine, 110 mm x 74 m (4,33 po x 242 pi), 3200, haute performance, âme de 12 mm (0,5 po), 12 rubans/boîte</p>
                                        <button onClick={() => {navigate("/consommables/03200GS11007"),window.scrollTo(0,0)}} className="bg-black mt-auto text-white hover:bg-orange-500 w-45 self-center h-11 rounded-2xl text-[16px] font-bold">Voir le produit</button>
                                    </div>
                                    <div className="flex flex-col text-start w-70 bg-white rounded-2xl p-4 gap-4">
                                        <img src={ribbon07} alt="" className="flex w-55 mx-auto" />
                                        <h1 className="text-2xl font-bold">Ruban YMCKLL</h1>
                            ...
                            <div>
                                ...
                                <div className="grid md:grid-cols-3 grid-cols-1 gap-7">
                                    <div className="flex flex-col text-start w-70 bg-white rounded-2xl p-4 gap-4">
                                        ...
                                        <h1 className="text-2xl font-bold">ZEBRA WHITE PVC CARDS</h1>
                                        <p>CARTES EN PVC BLANC ZEBRA, 30 MIL (500 CARTES)</p>
                                        <button onClick={() => {navigate("/consommables/104523-111"),window.scrollTo(0,0)}} className="bg-black mt-auto text-white hover:bg-orange-500 w-45 self-center h-11 rounded-2xl text-[16px] font-bold">Voir le produit</button>
                                    </div>
                                </div>
                            </div>
                        )}
                            ...
                            <div>
                                ...
                                <div className="grid md:grid-cols-3 grid-cols-1 gap-7">
                                    <div className="flex flex-col text-start w-70 bg-white rounded-2xl p-4 gap-4">
                                        ...
                                        <h1 className="text-2xl font-bold">Z-Band Direct Wristband</h1>
                                        ...
                                        <button onClick={() => {navigate("/consommables/10006995K"),window.scrollTo(0,0)}} className="bg-black mt-auto text-white hover:bg-orange-500 w-45 self-center h-11 rounded-2xl text-[16px] font-bold">Voir le produit</button>
                                    </div>
                                </div>
                            </div>
                        )}
